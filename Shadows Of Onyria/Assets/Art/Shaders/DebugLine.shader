...
Shader "DebugLine"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin][HDR]_Tint("Tint", Color) = (4.594794,0.2384091,0.2384091,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Emission = _Tint.rgb;
...
ASEEND*/
//CHKSM=454710B896A5EFF8692ABC8FC4D8EDFDC7208601